...
public class Constant {
	...
	public static final String EMAIL="shailendra.rajawat@nextgenclearing.com";
	...
	private static String environmentInfoSheet="FUATAPEX5";
	...
	public static String getChromeDriverLocation() {
		...
		if(platform.toLowerCase().contains("lin")){
			...
			val=root+"/"+serverExesFolderName+"/selenium_standalone_binaries/osx/googlechrome/"+bit+"/"+"chromedriver";
		}
		System.out.println("SHAILENDRA: "+val);
		return val;
	}
